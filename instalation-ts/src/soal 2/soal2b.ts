...
// Ambil elemen yang berisi lirik yang diinginkan
const desiredLyric = lirik_lagu.data.songLyricsArr.find(lyric => lyric.includes("For me to take what's mine, until the end of time?"));

console.log(desiredLyric); // Output: For me to take what's mine, until the end of time?